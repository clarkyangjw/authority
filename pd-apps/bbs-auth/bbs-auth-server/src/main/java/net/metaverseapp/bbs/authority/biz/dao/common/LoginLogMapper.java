package net.metaverseapp.bbs.authority.biz.dao.common;
...
public interface LoginLogMapper extends BaseMapper<LoginLog> {
     ...
     * @return 系统近十天来的访问记录
     */
    List<Map<String, Object>> findLastTenDaysVisitCount(@Param("tenDays") LocalDate tenDays, @Param("userUsername") String userUsername);

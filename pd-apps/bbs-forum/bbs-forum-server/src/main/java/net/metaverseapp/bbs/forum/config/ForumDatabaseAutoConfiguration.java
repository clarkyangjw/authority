...
@Slf4j
@MapperScan(
        basePackages = {"net.metaverseapp.bbs",},
        annotationClass = Repository.class,
        sqlSessionFactoryRef = ForumDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class, DatabaseProperties.class})
public class ForumDatabaseAutoConfiguration extends BaseDatabaseConfiguration {

    final static String DATABASE_PREFIX = "master";

    public ForumDatabaseAutoConfiguration(MybatisPlusProperties properties,
